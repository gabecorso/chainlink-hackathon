...
export default function CompanyProfile({company={name: 'CodeBerry', desc: 'Coding academy for children ages 7-18', etherScan: 'https://etherscan.io/chart/etherprice'}}) {
